...
public class Prasasti extends AppCompatActivity {
    ...
    private ImageView backToMenuArtefak, readMore, petaLokasi, tutupPopup;
    public LinearLayout popupPrasasti;
    ...
    private void initSelektor(){
        ...
        popupPrasasti = (LinearLayout) findViewById(R.id.prasasti_popup);
        tutupPopup = (ImageView) findViewById(R.id.close_popup_prasasti);
    }
    ...
    public void initListener(){
        ...
        readMore.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                popupPrasasti.setVisibility(View.VISIBLE);
            }
        });
        ...
        tutupPopup.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                popupPrasasti.setVisibility(View.GONE);
            }
        });

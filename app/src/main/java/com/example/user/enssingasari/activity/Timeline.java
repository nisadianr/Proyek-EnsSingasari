...
import com.example.user.enssingasari.activity.TextViewPlus;
...
public class Timeline extends AppCompatActivity {
    ...
    public void initSelektorGambar(){
        ...
        close = (ImageView) findViewById(R.id.close_button_u);
        right = (ImageView) findViewById(R.id.right_button_u);
        left = (ImageView) findViewById(R.id.left_button_u);
